...
class Panda:
  ...
  # Support both the legacy Panda VID and comma's registered VID. Newer Panda
  # firmware (including carrot) enumerates with 0x3801, and must be detected so
  # pandad can flash this branch's compatible firmware before boardd starts.
